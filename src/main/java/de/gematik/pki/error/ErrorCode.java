...
public enum ErrorCode {
    ...
    SE_1040(ErrorSeverity.ERROR, ErrorClassifier.SECURITY_ERROR, "CERTHASH_EXTENSION_MISSING",
        "Bei der Onlinestatusprüfung ist ENFORCE_CERTHASH_CHECK auf ´true´ gesetzt, die OCSP-Response enthält jedoch keine certHash Erweiterung"),
    SE_1041(ErrorSeverity.ERROR, ErrorClassifier.SECURITY_ERROR, "CERTHASH_MISMATCH",
