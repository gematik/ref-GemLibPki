...
public class OcspResponseGenerator {
  ...
  private OCSPResp gen(
    ...
    final BasicOCSPRespBuilder basicBuilder =
   ...
   */
  private static void addSingleResponseWithStatusGood(
      final BasicOCSPRespBuilder basicBuilder,
      final Req singleRequest,
      final Extensions extensions) {
    basicBuilder.addResponse(
        singleRequest.getCertID(),
