  ...
  public static Optional<Document> tslToDoc(@NonNull final TrustStatusListType tsl) {
    try {
      ...
      throw new GemPkiRuntimeException(
          "Konvertieren der TrustServiceStatusList in einen Dokumententyp fehlgeschlagen.", e);
    }
  }
    ...
    try {
      ...
      final JAXBElement<TrustStatusListType> jaxbElement =
          unmarshaller.unmarshal(
              bytesToDoc(tslBytes).orElseThrow().getFirstChild(), TrustStatusListType.class);
