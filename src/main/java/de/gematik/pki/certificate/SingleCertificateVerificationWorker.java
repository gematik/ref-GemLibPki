...
@Builder
public class SingleCertificateVerificationWorker {
    ...
    public void performCertificateChecks() throws GemPkiException {
        verifyValidity();
        verifySignature(getIssuerCertificate());
        verifyKeyUsage();
     ...
     */
    public String getCertificateAuthorityServiceStatus(@NonNull final TspService tspService) {
