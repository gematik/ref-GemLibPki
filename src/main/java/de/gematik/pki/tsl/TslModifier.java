...
public class TslModifier {

    /**
     * Modifies the service supply points (OCSP addresses) of a CA (PKC and SrvCertChange) entry for a given TSP. Other services, such as CRL, OCSP, CVC are not
     * altered
     *
     ...
     */
    public static void modifySspForCAsOfTsp(@NonNull final TrustStatusListType tsl, @NonNull final String tspName, @NonNull final String newSsp) {
     ...
     */
    public static void modifyNextUpdate(@NonNull final TrustStatusListType tsl, @NonNull final ZonedDateTime zdt) throws DatatypeConfigurationException {
    ...
    /**
     * Modifies the issueDate element of the given tsl and sets the nextUpdate element according to a given duration
     *
     * @param tsl                 The tsl to modify
     * @param issueDate           Utc timestamp of the new issueDate value
     * @param daysUntilNextUpdate Integer of the duration in days the tsl will be valid (issue+duration=nextUpdate)
     * @throws DatatypeConfigurationException if timestamp cannot be parsed
     */
    public static void modifyIssueDateAndRelatedNextUpdate(@NonNull final TrustStatusListType tsl, @NonNull final ZonedDateTime issueDate,
     ...
     * @throws DatatypeConfigurationException if timestamp cannot be parsed
     */
    public static void modifyIssueDate(@NonNull final TrustStatusListType tsl, @NonNull final ZonedDateTime zdt) throws DatatypeConfigurationException {
        final XMLGregorianCalendar xmlCal = getXmlGregorianCalendar(zdt);
     ...
     */
    public static void setOtherTSLPointers(@NonNull final TrustStatusListType tsl, @NonNull final Map<String, String> tslPointerValues) {
        ...
        for (final Map.Entry<String, String> entry : tslPointerValues.entrySet()) {
            oTslPointers.getOtherTSLPointer().add(index, createOtherTSLPointerType(entry.getKey(), entry.getValue()));
        }
     ...
     */
    public static void modifyTslDownloadUrlPrimary(@NonNull final TrustStatusListType tsl, @NonNull final String url) {
     ...
     */
    public static void modifyTslDownloadUrlBackup(@NonNull final TrustStatusListType tsl, @NonNull final String url) {
